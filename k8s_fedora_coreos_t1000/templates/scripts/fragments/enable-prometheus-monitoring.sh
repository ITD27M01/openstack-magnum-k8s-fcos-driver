...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
      - name: prometheus
        image: $(_set_prefix 'docker.io/prom/')prometheus:${PROMETHEUS_TAG}
        args:
...
spec:
  ...
  template:
    ...
    spec:
      containers:
        - image: $(_set_prefix 'docker.io/grafana/')grafana:${GRAFANA_TAG}
    ...
    spec:
      ...
      containers:
        - name: prometheus-node-exporter
          image: "$(_set_prefix 'docker.io/prom/')node-exporter:v0.15.2"
          imagePullPolicy: "IfNotPresent"
          args:
